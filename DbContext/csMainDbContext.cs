...
public class csMainDbContext : Microsoft.EntityFrameworkCore.DbContext
{
    ...
    private static DbContextOptionsBuilder<csMainDbContext> DbContextOptions (DbLoginDetail loginDetail)
    {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity("DbModels.csPetDbM", b =>
        {
            b.HasOne("DbModels.csFriendDbM", "FriendDbM")
                ...
                .OnDelete(DeleteBehavior.SetNull);  //Try DeleteBehavior.Cascade
